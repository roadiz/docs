...
copyright = str(now.year) + u', Ambroise Maupate & Julien Blanchet'
...
texinfo_documents = [
    ...
    'index',
    'Roadiz',
    u'Roadiz Documentation',
    u'Ambroise Maupate, Julien Blanchet',
    'Roadiz',
    u'Roadiz is a polymorphic CMS based on a node system that can handle many types of services. It is based on Symfony Flex, Doctrine ORM, API Platform, Twig for maximum performances and security.',
    'Miscellaneous'
    ),
]
...
epub_copyright = str(now.year) + u', Ambroise Maupate & Julien Blanchet'
